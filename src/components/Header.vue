...
<style lang="scss" rel="stylesheet/scss" scoped>
  ...
  .w-box {
    ...
    .user {
      ...
      &:hover {
        a:before {
          background: url(/static/images/account-icon@2x.32d87deb02b3d1c3cc5bcff0c26314ac.png) 25px -1px;
        }
        .nav-user-wrapper {
          top: 18px;
          visibility: visible;
    ...
    .shop {
      ...
      &:hover {
        a:before {
          content: " ";
          background: url(/static/images/account-icon@2x.32d87deb02b3d1c3cc5bcff0c26314ac.png) 30px -22px;
        }
      }
